...
const Profile = () => {
  ...
  return (
    <div
      className='flex flex-1 mt-3 flex-col gap-5 w-full h-[calc(100vh-80px)] sticky top-0 rounded-3xl'
      style={{
        backgroundImage: `linear-gradient(to bottom,  ${background},${lastElementColor})`,
      }}
    >
      ...
      <div className='w-full items-center justify-center flex flex-col gap-5 ml-2'>
        <input
          type='text'
          placeholder='Your Name'
          className='w-fit text-[24px] px-2 text-black outline-none flex items-center justify-center  break-words'
        />
        <textarea
          placeholder='Your bio'
          className='w-[60%] text-[16px] px-2 text-black h-[80px] break-words resize-none outline-none'
        />
      </div>
